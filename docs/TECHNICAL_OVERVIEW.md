...
All constitutional invariants are tested automatically. The test suite (1741 tests) covers every critical rule described in this document — including identity verification, compliance screening, three-tier justice, the genesis common fund, workflow orchestration, the labour market, skill lifecycle, domain trust, and persistence safety.
