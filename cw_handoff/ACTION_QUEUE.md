...
## COMPLETED
- [cx] [2026-03-05] Design debt: expose public event query on GenesisService (GenesisService.recent_events + EventLog.recent_events) | completed: 2026-03-05
- [cx] [2026-03-05] Design debt: EventLog.recent_events(n) bounded window reads (replaces unbounded events()) | completed: 2026-03-05
