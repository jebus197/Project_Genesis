...
- Distribution: trust-proportional but individually non-extractable. No per-actor balance query exists. The GCF balance is a derived accounting identity (contributed − disbursed + refunded) computed from the tamper-evident event log. Not a pool, not a vault. No bank. No custodian.
