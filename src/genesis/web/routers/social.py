        ...
        "scenes": [
            ...
            },
            {
                ...
                "paragraphs": [
                    ...
                    "The door, however, is not closed. The machine autonomy pathway has four tiers, each earned through demonstrated capability and community trust. Registration carries no operational privileges. Supervised clearance requires expert approval and annual review. Autonomous operation demands a strong domain trust record with instant revocation if standards slip. And Tier 3 — autonomous domain agency — is the furthest reach: five continuous years of flawless autonomous operation, followed by community approval.",
                    "Tier 3 is where the constitutional design gets interesting. The first machine of any new capability class must pass a full three-chamber constitutional amendment — society as a whole decides whether that type of machine intelligence warrants autonomous agency. But once a class is approved, subsequent machines of the same capability class go through procedural domain-expert verification: same evidence bar, no separate amendment. A machine outside any recognised class can still petition individually. The principle: the societal decision is made once per capability class, not once per machine.",
