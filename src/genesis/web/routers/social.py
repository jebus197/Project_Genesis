        ...
        "scenes": [
            {
                ...
                "paragraphs": [
                    "You visit a doctor. The doctor consults an AI. The AI recommends a treatment. That treatment affects your life. But nobody in the chain — not you, not the doctor, not the hospital — can inspect how the recommendation was produced, what evidence supported it, or who is accountable if it turns out to be wrong.",
            ...
            },
            {
                ...
                "summary": "The intellectual thread from Turing (1936) through Popper, cryptography, the cypherpunks, and Nakamoto to Genesis.",
                "paragraphs": [
                    ...
                    "The computational lineage is older still. In 1936, Alan Turing formalised what it means for a process to be computable — the foundation on which every digital system rests. During the war, Tommy Flowers built Colossus at Bletchley Park, proving that electronic machines could break codes at scale. In the 1970s, Diffie, Hellman, and Merkle showed that strangers could establish trust without a shared secret — public-key cryptography, the basis of every digital signature and blockchain anchor. The cypherpunks of the 1990s asked the political question: what if cryptography could protect individual autonomy from institutional overreach? And in 2008, Satoshi Nakamoto answered with Bitcoin: a public, tamper-evident ledger maintained by no one and verifiable by everyone.",
                    "Genesis connects all of these threads. Turing gives us computation. Flowers proves machines can operate at scale. Diffie-Hellman gives us trustless verification. The cypherpunks give us the political instinct. Nakamoto gives us the public ledger. Popper gives us the epistemological principle: keep institutions open to challenge. Constitutional design gives us the structure: encode rules so they apply equally to everyone — including the people who wrote them.",
                ...
                "points": [
                    "Turing (1936): formalised computation. Flowers (1943): proved machines could operate at scale.",
                    "Diffie-Hellman-Merkle (1970s): trustless verification. Cypherpunks (1990s): cryptography as political autonomy.",
                    "Nakamoto (2008): public, tamper-evident ledger without central authority.",
                    "Popper (1945): institutions must be open to criticism. Genesis: all threads woven into a constitutional work network.",
                ],
                "deep_link": "/audit",
        ...
        "scenes": [
            {
                ...
                "paragraphs": [
                    "Most platforms never ask the question honestly: can this survive without life support? First Light is Genesis asking it — out loud, with a constitutional tripwire attached. It is the precise moment the network crosses from proof-of-concept into self-sustaining operations, and it cannot be faked or delayed.",
            ...
            },
            {
                ...
                "paragraphs": [
                    "Right now, Genesis is small — deliberately small. The founding epoch (G0) is capped at fifty verified humans, with a hard time limit and a frozen constitution. Every decision the founders make is tagged provisional. When enough people arrive, those decisions face retroactive ratification: confirmed or reversed by the people who will actually live under them. Nobody gets to write the rules and then exempt themselves from review.",
                    "The network scales in four one-way transitions. Each epoch grants more governance power and demands more distributed participation. G0 is stewardship. G1 is the beginning of self-governance. G2 tightens geographic representation and scales the chambers. G3 — at two thousand verified humans — is the destination: full constitutional governance, complete chamber sizes, and the termination of the Genesis founding protocol. After G3, every decision is made by the people the decisions affect.",
                    "Two structural constraints hold across every epoch. Transitions are irreversible — there is no going back to a smaller, more centralised phase. And machines remain excluded from constitutional voting at every stage. That exclusion is deliberate, and changeable — but only through the most demanding amendment process the constitution defines.",
                ],
                "points": [
            ...
            },
            {
                ...
                "paragraphs": [
                    ...
                    "The door, however, is not closed. The machine autonomy pathway has four tiers, each earned through demonstrated capability and community trust. Registration carries no operational privileges. Supervised clearance requires expert approval and annual review. Autonomous operation demands a strong domain trust record with instant revocation if standards slip. And Tier 3 — autonomous domain agency — requires five continuous years of flawless operation, followed by community approval.",
                    "The first machine of any new capability class must pass a full three-chamber constitutional amendment — society as a whole decides whether that type of intelligence warrants autonomous agency. Once a class is approved, subsequent machines go through procedural domain-expert verification: same evidence bar, no separate amendment. The principle: the societal decision is made once per capability class, not once per machine.",
                    "Economic coexistence follows a parallel logic. Machine work is valued at a constitutional discount — currently 50% — with the differential flowing to the Genesis Common Fund. This may sound steep per-unit, but machine work will vastly outnumber human work in volume terms. Even at 50%, the GCF receives enormous funding from the sheer throughput. The GCF has a natural disposition toward STEM research and infrastructure — the kind of work that advances the technological frontier. As machine capabilities progress (which they will, regardless of Genesis), Tier 3 recognition becomes achievable, and the discount evaporates. The mechanism is probably self-eliminating — not because we mandate it, but because the trajectory of technology makes it the likely outcome.",
                ...
                "points": [
                    ...
                    "Machine work valued at a constitutional discount (50%), differential flows to GCF.",
                    "GCF's STEM/infrastructure disposition means the mechanism is probably self-eliminating — technology advances regardless.",
            ...
            },
            {
                ...
                "paragraphs": [
                    ...
                    "The system operates through a threat signal protocol. Any node can raise an alarm, and signals propagate with cryptographic verification — you cannot forge a threat signal any more than you can forge a trust score. The network watches for patterns that individual nodes might miss: unusual trust trajectories, coordinated behaviour across apparently unrelated accounts, quality scores that drift in ways inconsistent with genuine work. No single mechanism catches everything. The strength is in the overlap.",
                    "Response is graduated, and the stakes determine who decides. Routine threats — quarantine, trust adjustment, activity suspension — are handled automatically. But when the stakes are high, a human must be in the loop. Domain experts are selected randomly from a qualified pool for each case. You cannot predict who will review yours, and you cannot lobby a standing committee that does not exist.",
